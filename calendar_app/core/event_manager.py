...
class EventManager:
    ...
    def create_event(self, event: Event) -> int:
        ...
        try:
            ...
            logger.info(f"✅ Created event: {event.get_display_title()} (ID: {event_id})")
            return event_id
    ...
    def get_events_by_category(self, category: str) -> List[Event]:
        ...
        try:
            ...
            logger.debug(f"🏷️ Found {len(category_events)} events in category '{category}'")
    ...
    def export_events_to_csv(self, events: List[Event], file_path: Union[str, Path]) -> bool:
        ...
        try:
            ...
            with open(file_path, 'w', newline='', encoding='utf-8') as csvfile:
                fieldnames = [
                    ...
                    'end_date', 'end_time', 'is_all_day', 'category', 'color'
                ]
    ...
    def import_events_from_csv(self, file_path: Union[str, Path]) -> List[Event]:
        ...
        try:
            ...
            logger.info(f"📥 Imported {len(imported_events)} events from CSV: {file_path}")
            return imported_events
    ...
    def restore_events(self, backup_path: Union[str, Path], clear_existing: bool = False) -> int:
