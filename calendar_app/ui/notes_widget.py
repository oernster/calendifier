...
from PySide6.QtWidgets import (
    ...
    QPushButton, QMessageBox, QTabBar
)
...
class NotesWidget(QWidget):
    ...
    def _setup_ui(self):
        ...
        # Set fixed height for the notes widget
        ...
        try:
            ...
            if len(self.notes) <= 1:
                QMessageBox.information(
                    ...
                    _("notes.message_must_have_one_note", default="You must have at least one note.")
                )
                return
            ...
            msg_box.setText(_("dialogs.confirm_delete_note", default="Are you sure you want to delete this note?"))
