            ...
            "modules": [
                ...
                },
                {
                    ...
                    "build-commands": [
                        ...
                        "install -Dm755 main.py ${FLATPAK_DEST}/bin/calendifier-main.py",
                        "cp -r calendar_app ${FLATPAK_DEST}/lib/python3.11/site-packages/",
                        "cp version.py ${FLATPAK_DEST}/lib/python3.11/site-packages/",
                        "cp requirements.txt ${FLATPAK_DEST}/lib/python3.11/site-packages/",
